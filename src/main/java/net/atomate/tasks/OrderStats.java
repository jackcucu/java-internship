...
import net.atomate.util.AveragingBigDecimalCollector;
 ...
 * <p>
 * Refer to the <code>net.atomate</code>.model</code> package to observe the domain model of the shop.
 */
class OrderStats
{
     ...
     */
    static List<Order> ordersForCardType(final Stream<Customer> customers, final PaymentInfo.CardType cardType)
    {
        return null;
    }
